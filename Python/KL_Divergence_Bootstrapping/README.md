...
Converts them into 2D histograms (probability grids)
Computes:
K
L
(
...
Reports a 95% confidence interval (percentile method)
Optionally:
...
i
​	
  = real distribution probability in bin i
Q
i
Q 
i
​	
  = synthetic distribution probability in bin i
A small epsilon is added to all bins to prevent division by zero.
Bootstrap Procedure
For each bootstrap iteration:
Sample real data with replacement
...
📜 License
Add your preferred license here (MIT recommended for academic tools).
👤 Author
Soheil Jamali
